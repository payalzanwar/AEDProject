 ...
 */
public class SupplyManagerLoginFormJPanel extends javax.swing.JPanel {
   ...
   // private JPanel PContainer;
    ...
    public SupplyManagerLoginFormJPanel(JPanel PContainer, Organization organization,Employee employee,Role role) {
    initComponents();
    ...
    private void submitbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitbtnActionPerformed
        ...
        String supplierLocation = supplierLoctxt.getText();
        String userName = usernametxt.getText();
        String password = passwordtxt.getText();
        String repassword = confirmpswdtxt.getText();

        suppDir.createSupplier(supplierName,supplierLocation);
        this.organization.getUserAccountDirectory().createUserAccount(userName, password, this.employee, this.role);
        JOptionPane.showMessageDialog(PContainer, "Supply Manager created successfully!");
